...
public class VideoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public VideoAdapter(Context context, ArrayList<DataVideo> arr){
...
//        return new VideoViewHolder(view);
        ...
        switch (i){
            case 1:
                View view = layoutInflater.inflate(R.layout.top_video,viewGroup, false);
                return new VideoViewHolder(view);
            case 0:
                View view2 = layoutInflater.inflate(R.layout.item_video2,viewGroup, false);
